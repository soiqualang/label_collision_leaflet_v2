...
L.LayerGroup.Collision = L.LayerGroup.extend({
	...
	addLayer: function(layer) {
		...
		//prefetch bản đồ sau khi remove layer
		this._rbush = rbush();
...
// 				}
	...
	rmlayer: function(){
		...
		L.LayerGroup.collision({margin:5}).__proto__._cachedRelativeBoxes=[];
		L.LayerGroup.collision({margin:5}).__proto__._originalLayers=[];
		L.LayerGroup.collision({margin:5}).__proto__._visibleLayers=[];
